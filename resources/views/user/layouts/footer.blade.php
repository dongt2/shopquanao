        ...
        <div class="row">
            <div class="col-md-6 col-lg-3 col-xl-3">
                <div class="footer-widget">
                    <div class="logo">
                        <a href="#">
                            <img src="{{ asset('assets/media/images/logo2.png') }}" alt="">
                        </a>
                    </div>
            ...
            <div class="col-md-6 col-lg-3 col-xl-3">
                <div class="footer-widget">
                    ...
                    <div class="payment-link">
                        <ul>
                            <li><a href="#"><img src="{{ asset('assets/media/images/p1.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/media/images/p2.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/media/images/p3.png') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/media/images/p4.png') }}" alt=""></a></li>
                        </ul>
                    </div>
                </div>
