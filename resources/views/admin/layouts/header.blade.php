                                ...
                                <div class="adomx-dropdown-menu dropdown-menu-mail">
                                    ...
                                    <div class="body custom-scroll">
                                        <ul>
                                            <li>
                                                <a href="#">
                                                    <div class="image"><img src="{{ asset('admin/assets/images/avatar/avatar-2.jpg') }}" alt=""></div>
                                                    <div class="content">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <div class="image"><img src="{{ asset('admin/assets/images/avatar/avatar-1.jpg') }}" alt=""></div>
                                                    <div class="content">
